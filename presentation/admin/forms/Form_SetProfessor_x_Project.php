...
$sid = "";
    ...
    $disabled = ($infoProject->getState()==3 && $professor_x_project_turn !=0);
    ...
    <div class="form-group">
        <label for="form_set_activeProfessors_search">
            ...
            <?= (!$disabled) ? "<table class='table table-sm table-striped' id='professorList'></table>" :
                               "<small class='segan minitext'>Selecciona los jurados <br> cuando el estado esté en <br>'Revisado por el tutor'</small>"
                           ?>
